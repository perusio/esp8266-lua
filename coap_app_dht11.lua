...
--- Gets the readings from the sensors.
--
-- @return tabĺe
...
local function acquire_data()
  ...
  -- Return the values. Note that for this to work all variables
  -- need to be global.
  return {
    {
      meaning = 'temperature',
...
local function setup()
  ...
  cs:listen(5683)
  -- Variables.
  cs:var('adc_reading') -- get coap://xx.xx.xx.xx:5683/v1/v/adc_reading will return the value of 'adc_reading'
  cs:var('temp')
  cs:var('hum')
  -- Get all at once.
  content_msg = '{"key":"value"}' -- this variable needs to be global
  cs:var('content_msg', coap.JSON) -- sets content type to JSON

  -- Function should tack one string, return one string.
  cs:func('foo') -- POST coap://xx.xx.xx.xx:5683/v1/f/foo invokes foo
